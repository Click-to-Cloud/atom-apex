...
var zGhuQ = function (_Component) {
  _inherits(zGhuQ, _Component);

  function zGhuQ() {
    _classCallCheck(this, zGhuQ);

    return _possibleConstructorReturn(this, (zGhuQ.__proto__ || Object.getPrototypeOf(zGhuQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zGhuQ, _indexSoy2.default);

exports.default = zGhuQ;
...
exports.templates = exports.zGhuQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zGhuQ.
   * @public
   */

  goog.module('zGhuQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zGhuQ.render';
  }
...
_metalSoy2.default.register(zGhuQ, templates);
exports.zGhuQ = zGhuQ;
