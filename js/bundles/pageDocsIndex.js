...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    $templateAlias1({ items: opt_data.site.topbar, style: 'topbar-light topbar-docs', logo: { text: opt_data.site.title, href: '/atom-apex', icon: 'icon-16-hammer' } }, null, opt_ijData);
