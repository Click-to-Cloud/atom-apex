...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/atom-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Atom.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Your apex code has always been working fine until someday it fails because of a huge amount of data. Usually this is because your code does not scale well. Atom.apex gives you this scalability and you only need to focus on your business logic.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Governor Limit Proof');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Atom.apex guards your code executing without being interrupted by governor limits.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Functional Support');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Atom.apex integrates functions to build your business logic.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Atom.apex can be extended to meet your needs.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'col-md-12 col-md-offset-2');
    ie_open('h3', null, null, 'class', 'about-title');
    itext('Governor Limit Free');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Atom.apex tries to set a governor limit free environment for your code to run.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Multi-step Execution');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Atom.apex splits your business logic into steps, which can be executed in multiple queueable jobs.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/atom-apex/images/highlight_1.png', 'alt', 'Multi-step Execution', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Atom.apex can be integrated easily with functions.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/atom-apex/images/highlight_2.png', 'alt', 'Functional Support', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
