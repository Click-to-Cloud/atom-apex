...
var wVxMn = function (_Component) {
  _inherits(wVxMn, _Component);

  function wVxMn() {
    _classCallCheck(this, wVxMn);

    return _possibleConstructorReturn(this, (wVxMn.__proto__ || Object.getPrototypeOf(wVxMn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wVxMn, _step_2Soy2.default);

exports.default = wVxMn;
...
exports.templates = exports.wVxMn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wVxMn.
   * @public
   */

  goog.module('wVxMn.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param973 = function param973() {
      ...
      ie_close('p');
      ie_open('p');
      itext('Atom.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wVxMn.render';
  }
...
_metalSoy2.default.register(wVxMn, templates);
exports.wVxMn = wVxMn;
